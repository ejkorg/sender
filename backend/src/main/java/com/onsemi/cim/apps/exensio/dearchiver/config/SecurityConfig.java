...
import com.onsemi.cim.apps.exensio.dearchiver.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(new JwtAuthenticationFilter(new com.onsemi.cim.apps.exensio.dearchiver.security.JwtUtil()), BasicAuthenticationFilter.class);
