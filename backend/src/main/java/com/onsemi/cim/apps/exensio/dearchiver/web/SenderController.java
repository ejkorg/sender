...
import com.onsemi.cim.apps.exensio.dearchiver.service.SenderDispatchService;
...
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.DiscoveryPreviewRequest;
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.DiscoveryPreviewResponse;
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.StagePayloadRequest;
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.StagePayloadResponse;
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.DispatchRequest;
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.DispatchResponse;
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.DuplicatePayloadView;
import com.onsemi.cim.apps.exensio.dearchiver.web.dto.EnqueueRequest;
...
public class SenderController {
    ...
    private final com.onsemi.cim.apps.exensio.dearchiver.service.MetadataImporterService metadataImporterService;
    private final com.onsemi.cim.apps.exensio.dearchiver.service.MetricsService metricsService;
    private final RefDbService refDbService;
    private final SenderDispatchService senderDispatchService;
    public SenderController(SenderService senderService, SenderQueueRepository repo, com.onsemi.cim.apps.exensio.dearchiver.service.MetadataImporterService metadataImporterService, com.onsemi.cim.apps.exensio.dearchiver.service.MetricsService metricsService, RefDbService refDbService, SenderDispatchService senderDispatchService) {
    ...
    public ResponseEntity<com.onsemi.cim.apps.exensio.dearchiver.web.dto.EnqueueResult> enqueue(@PathVariable("id") Integer id, @RequestBody EnqueueRequest req) {
        Integer senderId = id;
        ...
        com.onsemi.cim.apps.exensio.dearchiver.web.dto.EnqueueResult result = new com.onsemi.cim.apps.exensio.dearchiver.web.dto.EnqueueResult(holder.enqueuedCount, holder.skippedPayloads);
    ...
    public ResponseEntity<String> discover(@PathVariable("id") Integer id,
        ...
        if (locationId != null && (site == null || site.equals("default") || site.isBlank())) {
            com.onsemi.cim.apps.exensio.dearchiver.entity.ExternalLocation loc = metadataImporterService.findLocationById(locationId);
    ...
    public ResponseEntity<java.util.List<java.util.Map<String,Object>>> lookupSenders(@RequestParam(defaultValue = "default") String site,
        ...
        try {
            com.onsemi.cim.apps.exensio.dearchiver.entity.ExternalLocation loc = null;
            ...
            try (java.sql.Connection c = conn) {
                ...
                java.util.List<com.onsemi.cim.apps.exensio.dearchiver.repository.SenderCandidate> res = metadataImporterService.findSendersWithConnection(c, metadataLocation, dataType, testerType, testPhase);
                    java.util.List<java.util.Map<String,Object>> out = new java.util.ArrayList<>();
                    for (com.onsemi.cim.apps.exensio.dearchiver.repository.SenderCandidate s : res) {
    ...
    public ResponseEntity<java.util.List<java.util.Map<String,Object>>> externalSenders(@RequestParam(required = false, name = "locationId") Long locationId,
        ...
        try {
            ...
            try (java.sql.Connection c = conn) {
                ...
                java.util.List<com.onsemi.cim.apps.exensio.dearchiver.repository.SenderCandidate> senders = metadataImporterService.findAllSendersWithConnection(c);
                java.util.List<java.util.Map<String,Object>> out = new java.util.ArrayList<>();
                for (com.onsemi.cim.apps.exensio.dearchiver.repository.SenderCandidate s : senders) {
                    java.util.Map<String,Object> m = new java.util.HashMap<>();
                    m.put("idSender", s.getIdSender());
                    m.put("name", s.getName());
